...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ image('logos/GladRags.svg') }}" class="h-25px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/GladRags.svg') }}" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
