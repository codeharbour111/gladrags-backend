<x-default-layout>
    ...
    <div class="card card-flush h-lg-50">
        ...
        <div class="card-body py-4">
            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0" id="kt_docs_datatable_subtable">
                <!--begin::Table head-->
                <thead>
                    <!--begin::Table row-->
                    <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                        <th class="min-w-40px">Order ID</th>
                        <th class="text-center min-w-25px">Customer</th>
                        <th class="text-center min-w-20px">Quantity</th>
                        <th class="text-center min-w-20px">Total</th>
                        <th class="text-center min-w-25px">Status</th>
                        <th class="text-center min-w-25px pe-12">Action</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ URL("/order/detail/{$order->id}") }}"
                                    class="text-gray-900 text-hover-primary">{{ $order->order_number }}</a>
                            </td>
                            <!--end::Order ID-->
                            ...
                            <ul class="pagination">
                                <li class="dt-paging-button page-item disabled">
                                    <button class="page-link previous" role="link" type="button"
                                        aria-controls="kt_customers_table" aria-disabled="true" aria-label="Previous"
                                        data-dt-idx="previous" tabindex="-1"><i class="previous"></i></button>
                                </li>
                                <li class="dt-paging-button page-item active">
                                    <button class="page-link" role="link" type="button"
                                        aria-controls="kt_customers_table" aria-current="page"
                                        data-dt-idx="0">1</button>
                                </li>
                                <li class="dt-paging-button page-item">
                                    <button class="page-link" role="link" type="button"
                                        aria-controls="kt_customers_table" data-dt-idx="1">2</button>
                                </li>
                                <li class="dt-paging-button page-item">
                                    <button class="page-link" role="link" type="button"
                                        aria-controls="kt_customers_table" data-dt-idx="2">3</button>
                                </li>
                                <li class="dt-paging-button page-item">
                                    <button class="page-link" role="link" type="button"
                                        aria-controls="kt_customers_table" data-dt-idx="3">4</button>
                                </li>
                                <li class="dt-paging-button page-item">
                                    <button class="page-link next" role="link" type="button"
                                        aria-controls="kt_customers_table" aria-label="Next" data-dt-idx="next"><i
                                            class="next"></i></button>
                                </li>
                            </ul>
                        </nav>
