<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('categories.add.new.category') }}
    @endsection
    ...
    <div class="card">
        <div class="card mb-5 mb-xl-10">
            ...
            <div>
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" enctype="multipart/form-data" action="{{ route('store.category') }}">
                    @csrf
                    ...
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="Category name" value="{{ old('name') }}">
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center mt-3">
                                    @foreach(['S', 'M', 'L', 'XL', 'XXL'] as $size)
                                        <label class="form-check form-check-custom form-check-inline form-check-solid me-5">
                                            <input class="form-check-input" name="sizes[]" type="checkbox" value="{{ $size }}" {{ in_array($size, old('sizes', [])) ? 'checked' : '' }}>
