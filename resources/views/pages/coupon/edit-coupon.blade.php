<x-default-layout>
    ...
    <div class="card">
        <div class="card mb-5 mb-xl-10">
            ...
            <div>
                <form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" enctype="multipart/form-data" action="{{ route('coupon.update', $coupon->id) }}" }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="code" class="form-control form-control-lg form-control-solid" placeholder="Coupon code" value="{{ $coupon->code }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="expire_date" class="form-control form-control-lg form-control-solid" value="{{ date('Y-m-d', strtotime($coupon->expire_date)) }}">
                        </div>
